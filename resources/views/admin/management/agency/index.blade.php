                ...
                <div class="container card-header">
                    <div class="row">
                        <div class="col order-last PromptRegular16">
                            <div class="float-md-right">
                                <a href="{{ route('agency.create') }}">
                                    <button type="button" class="btn btn-outline-primary" ><i class="fas fa-plus-square"></i> สร้างข้อมูลหน่วยงานพันธมิตร</button>
                                </a>
                            </div>
                        </div>
                        <div class="col">
                        ...
                        <div class="col order-first PromptRegular20">
                            <i class="fas fa-building"></i> ข้อมูลหน่วยงานพันธมิตร 
                        </div>
                    </div>
                </div>

                <div class="card-body table-responsive-md PromptRegular16">
                    <table id="agency" class="table table-condensed table-hover responsive display nowrap" style="width:100%">
                        <thead>
                            <tr class="table-active">
                                <th scope="col">#</th>
                                <th scope="col">สถานะ</th>
                                <th scope="col">หมายเลขร้านค้า</th>
                                <th scope="col">รหัสหน่วยงานพันธมิตร</th>
                                <th scope="col">ชื่อหน่วยงานพันธมิตร</th>
                                <th scope="col"></th>
                            </tr>
                        </thead>
                        <tbody>
                            ...
                            <th scope="row">{{ $key + 1 }}</th>
                                ...
                                @endif
                                <td>{{ $agency->merchant_code }}</td>
                                <td>{{ $agency->agency_code }}</td>
                                <td>{{ $agency->agency_name }}</td>
                                <td>
                                    <a href="{{ route('agency.show',Crypt::encryptString($agency->id)) }}">
